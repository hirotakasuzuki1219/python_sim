...
- アニメーションやゲームなどの制作者、ものづくり系エンジニアを目指す人
  - 2025年卒のN高、S高、R高の生徒は、45.54%が大学進学、10.28%が就職している。（[N高、S高、R高 HP](https://nnn.ed.jp/results/)）
    - 神戸製鋼所などの製造業への就職や、イラストレーター・アーティストなど、クリエイティブ業界への進出も（[2024年度就職実績](https://nnn.ed.jp/results/job/)）
...
| 9 | Blenderの物理エンジンを使ってみよう Ⅰ | 基本操作, Python Scripting |
...
### 他の物理エンジンを活用したシミュレーション、クリエイティブ制作
