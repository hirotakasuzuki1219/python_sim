...
| 8 | ソルバーの拡張 | ルンゲクッタ法、（陰解法？） |
| 9 | 計算モデルの拡張 | 減衰、空気抵抗など |
| 10 | 多自由度系への拡張 | 複数のバネのシミュレーション（２Dのソフトボディ、布） |
| 11 | Blenderの物理エンジンを使ってみよう Ⅰ | 基本操作 |
| 12 | Blenderの物理エンジンを使ってみよう Ⅱ | 剛体 |
| 13 | Blenderの物理エンジンを使ってみよう Ⅲ | 布 |
| 14 | Blenderの物理エンジンを使ってみよう Ⅳ | ソフトボティ |
